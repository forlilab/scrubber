...
geom.add_argument("--numconfs", help="Number of initial conformers generated by ETKDG (default=3). \nNote that this does not change the number of molecules produced.", type=int)
