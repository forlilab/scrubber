...
setup(
    ...
    description="Tool to process chemical data to manipulate chemical data to generate high-quality 3D coordinates for small molecules",
    long_description=open(os.path.join(base_dir, "README.md")).read(),
    long_description_content_type="text/markdown",
    packages=find_packages(),
    scripts=["scripts/scrubber_run.py",],
